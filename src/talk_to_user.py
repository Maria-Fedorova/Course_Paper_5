...
def user_interaction():
    ...
    while True:
        user_query = input("""
        \rЧто Вы хотели бы получить? Напишите нужную цифру
        \r1 - список всех компаний и количество вакансий у каждой компании:
        \r2 - список всех вакансий с указанием названия компании, названия вакансии, зарплаты
        \rи ссылки на вакансию
        \r3 - среднюю зарплату по вакансиям
        \r4 - список всех вакансий, у которых зарплата выше средней по всем вакансиям
        \r5 - список всех вакансий, в названии которых содержатся переданные в метод слова, например "специалист"
        \r0 - выход\n""")
        ...
        if user_query == "1":
            ...
            while True:
                user_count_2 = int(input("Сколько вакансий хотите получить? Укажите цифру\n"
                                         f"Общее кол-во вакансий {len(list_all_vacancies)}\n"))
                if 0 < user_count_2 <= len(list_all_vacancies):
                    for vacancy in list_all_vacancies[:user_count_2]:
            ...
            while True:
                user_count_issue_4 = int(input("Сколько вакансий хотите получить? Укажите цифру\n"
            ...
            if len(keyword) > 0:
                while True:
                    user_count_issue_5 = int(input("Сколько вакансий хотите получить? Укажите цифру\n"
